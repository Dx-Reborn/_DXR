...
public:
    ...
    NO_DEFAULT_CONSTRUCTOR(USpline)
};
...
#define UCONST_MAXSTEPHEIGHT 25.0
...
public:
    ...
    NO_DEFAULT_CONSTRUCTOR(AxProcMesh)
};
...
public:
    ...
    NO_DEFAULT_CONSTRUCTOR(AxPickUpBase)
};
...
public:
    ...
    NO_DEFAULT_CONSTRUCTOR(AxEmitter)
};
...
public:
    ...
    NO_DEFAULT_CONSTRUCTOR(USubActionSubTitle)
};
...
public:
    ...
    NO_DEFAULT_CONSTRUCTOR(UManifest)
};
