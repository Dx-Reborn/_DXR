...
#exec Texture Import File=Textures\S_TerrainInfo.tga Name=S_TerrainInfo Mips=Off MASKED=true ALPHA=true
#exec Texture Import File=Textures\S_WhiteCircle.tga Name=S_WhiteCircle Mips=Off MASKED=true ALPHA=true
#exec Texture Import File=Textures\TerrainBad.tga Name=TerrainBad Mips=Off
#exec Texture Import File=Textures\DecoPaint.tga Name=DecoPaint Mips=Off
