...
event InitGame( string Options, out string Error )
{
    ...
    log(self$" InitGame, options = "$Options$", Error = "$Error);
...
function InitSavedLevel()
{
    ...
    if ( Level.ObjectPool == None )
        ...
        log(self@"InitSavedLevel, Level.ObjectPool = "$Level.ObjectPool$" Level.GRI = "$GameReplicationInfo);
}
...
*/
function bool PickupQuery( Pawn Other, /*Pickup*/ Inventory item )
{
