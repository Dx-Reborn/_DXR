...
//-----------------------------------------------------------------------------
// Internal.
var(Hidden) editconst vector       KeyPos[24];
var(Hidden) editconst rotator      KeyRot[24];
var(Hidden) editconst vector       BasePos, OldPos, OldPrePivot, SavedPos;
var(Hidden) editconst rotator      BaseRot, OldRot, SavedRot;
