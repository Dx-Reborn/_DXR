...
#exec Texture Import File=Textures\WhiteSquareTexture.tga
#exec Texture Import File=Textures\LargeVertex.tga Name=LargeVertex
...
var() string DefaultGameType;  //DeusEx.DeusExGameInfo
...
//	PreCacheGame="xGame.xDeathMatch"
    // -- DXR
    DefaultGameType="DeusEx.DeusExGameInfo"
    PreCacheGame="DeusEx.DeusExGameInfo"

    bSupportSaveGames=true // now true by default, to avoid warnings, related to Octree.
	  // DXR --
