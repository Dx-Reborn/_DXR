...
#exec TEXTURE IMPORT NAME=MenuWhite FILE=Textures\MenuWhite.tga MIPS=0
#exec TEXTURE IMPORT NAME=MenuBlack FILE=Textures\MenuBlack.tga MIPS=0
#exec TEXTURE IMPORT NAME=MenuGray  FILE=Textures\MenuGray.tga MIPS=0
