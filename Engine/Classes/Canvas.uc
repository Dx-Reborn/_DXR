...
#exec TEXTURE IMPORT NAME=WhiteTexture FILE=Textures\WhiteTexture.tga MIPS=0
#exec TEXTURE IMPORT NAME=BlackTexture FILE=Textures\BlackTexture.tga MIPS=0
#exec TEXTURE IMPORT NAME=GrayTexture  FILE=Textures\GrayTexture.tga MIPS=0

// simple default font, so various stuff doesn't crash
#exec Font Import File=Textures\MedFont.pcx Name="DefaultFont"
...
final function DrawIconEx(Material mat, float Scale ) // DXR: Added version for material
{
	if ( mat != None )
		DrawTile(mat, mat.MaterialUSize()*Scale, mat.MaterialVSize()*Scale, 0, 0, mat.MaterialUSize(), mat.MaterialVSize());
}
