...
#exec Texture Import File=Textures\S_Player.tga Name=S_Player Mips=Off MASKED=true ALPHA=true
...
defaultproperties
{
     ...
     // Подводки для PlayerStart по умолчанию нет, в нашем случае они бесполезны.
     bForcedOnly=true
}
