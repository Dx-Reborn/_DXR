...
// Ïîñêîëüêó äîïîëíèòåëüíûå ïåðåìåííûå ÿ äîáàâèòü íå ìîãó (ïðîèñõîäèò âûëåò),
// ÿ äîáàâëþ, ôóíêöèè, âîçâðàùàþùèå òî, ÷òî ìíå íóæíî.
function string GetBindName();
function string GetBarkBindName(); // Used to bind Barks!

// Íó, êàêèå åùå çàïðîñû?
...
function array<object> GetConListItems(); // âîçâðàùàåò conListItems
function SetConListItems(object AconListItems); // âûñòàâëÿåò conListItems
function object NoneConListItems(); // âûñòàâëÿåò conListItems â none
