/**/
class STY_DXR_DeusExCheckBox extends DXRStyles;// GUI2Styles;

defaultproperties
{
	KeyName="STY_DXR_DeusExCheckBox"
	Images(0)=Material'DeusExUI.UserInterface.PersonaCheckBox_Off'
	Images(1)=Material'DeusExUI.UserInterface.PersonaCheckBox_Off'
	Images(2)=Material'DeusExUI.UserInterface.PersonaCheckBox_Off'
	Images(3)=Material'DeusExUI.UserInterface.PersonaCheckBox_Off'
	Images(4)=Material'DeusExUI.UserInterface.PersonaCheckBox_Off'
