...
class MenuChoice_DefaultTexMipBias extends DXREnumButton;
...
defaultproperties
{
    ...
    Hint="Values less than 0 will add fake 'sharpness' to textures, but will decrease performance, and vice versa."
    actionText="Textures Mip Bias"
    configSetting="ini:Engine.Engine.RenderDevice DefaultTexMipBias"
