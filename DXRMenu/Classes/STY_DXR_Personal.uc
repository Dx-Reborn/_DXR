/**/
class STY_DXR_Personal extends DXRStyles;
...
defaultproperties
{
	...
	Images(0)=Material'DXR_PersonaButtonA'
	Images(1)=Material'DXR_PersonaButtonA'
	Images(2)=Material'DXR_PersonaButtonA'
	Images(3)=Material'DXR_PersonaButtonA'
	Images(4)=Material'DXR_PersonaButtonA'
