...
//  FONT_NUM=11
    ...
    /* ¬се курсоры уменьшены примерно в три раза */
...
//    MouseCursorOffset(0)=(X=0.5,Y=0.5,Z=0) // —мещение курсора

        DblClickWindow=0.5 // How long do you have for a double click//0.05
                            // было 0.5. ѕришлось уменьшить, иначе диалоги проматывались слишком быстро.
    bFixedMouseSize=true // »збавл€ет от проблемы с измен€ющим размеры курсором :)
