...
var() material ConsoleBackground, ConsoleLowerLine;
...
state ConsoleVisible
{
    ...
    function PostRender( canvas Canvas )
    {
        ...
        Canvas.Style=4;
// Что это было ? 0_o      Canvas.DrawTileStretched(material'ConsoleBack',Canvas.ClipX,yClip);
        Canvas.DrawTileStretched(ConsoleBackground,Canvas.ClipX,yClip);
        Canvas.Style=1;

        Canvas.SetPos(0,yclip-1);
        Canvas.SetDrawColor(255,255,255,255);
        Canvas.DrawTile(ConsoleLowerLine,Canvas.ClipX,2,0,0,64,2);
// Что это было ? 0_o Canvas.DrawTile(texture 'InterfaceContent.Menu.BorderBoxA',Canvas.ClipX,2,0,0,64,2);
...
//  SMDenySound=sound'MenuSounds.SelectK'
    ...
    DemoPlaybackSpeeds(0)=0.25;
    DemoPlaybackSpeeds(1)=0.5;
    DemoPlaybackSpeeds(2)=1.1;
    DemoPlaybackSpeeds(3)=2.0;
    DemoPlaybackSpeeds(4)=4.0;
