...
// WeaponBaton.
//=============================================================================
class WeaponBaton extends H2H_Weapon;
...
function Sound GetDownSound()
{
    ...
    if (gl.bUseAltWeaponsSounds)
    {
        sound = class'DXRWeaponSoundManager'.static.GetBatonDown(gl.WS_Preset);
        if (sound != None)
        return sound;
        else
...
defaultproperties
{
     ...
     PickupViewMesh=Mesh'DeusExItems.BatonPickup'
     FirstPersonViewMesh=Mesh'DeusExItems.Baton'
     Mesh=Mesh'DeusExItems.BatonPickup'
