//=============================================================================
// ConCamera. Объект, содержащий аналог функции 
// DeusExPlayerController.PlayerCalcView(...) Необходим для управления этой
// функцией. В оригинале функция находилась в DeusExPlayer.
//=============================================================================
...
var ECameraPosition cameraFallbackPositions[9];
var ECameraPosition cameraHeightPositions[9];
