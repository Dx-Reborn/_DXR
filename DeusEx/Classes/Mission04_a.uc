...
// Mission04.
//=============================================================================
class Mission04_a extends MissionScript;
...
/*                  if(DeusExRootWindow(Player.rootWindow).hud.belt.objects[count].GetItem() != None && !DeusExRootWindow(Player.rootWindow).hud.belt.objects[count].GetItem().IsA('NanoKeyRing'))
                ...
                Level.Game.SendPlayer(/*Player*/Level.GetLocalPlayerController(), "05_NYC_UNATCOMJ12Lab"); // DXR: PlayerController, not playerPawn.
            }
        }
    }
