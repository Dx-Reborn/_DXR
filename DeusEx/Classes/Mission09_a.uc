...
// Mission09.
//=============================================================================
class Mission09_a extends MissionScript;
...
function ShipExplosionEffects(bool bFragments)
{
    ...
    if (Player.HeadVolume != None)
    {
        Player.HeadVolume.AmbientSound = sound'Klaxon';
        Player.HeadVolume.SoundRadius = 255;
        Player.HeadVolume.SoundVolume = 255;
    }
}
