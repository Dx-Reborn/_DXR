...
// Mission01.
//=============================================================================
class Mission01_a extends MissionScript;
...
//            foreach AllActors(class'Terrorist', T)
            foreach DynamicActors(class'Terrorist', T)
                count++;
...
//            foreach AllActors(class'TerroristCarcass', carc)
            foreach DynamicActors(class'TerroristCarcass', carc)
            {
            ...
            if (flags.GetBool('StatueMissionComplete'))
            {
                ...
                foreach AllActors(class'ScriptedPawn', P)
                {
                    ...
                    else if (P.IsA('Terrorist') && (P.BindName != "TerroristCommander"))
                    {
                        ...
                        P.HealthTorso = 0;
                        P.Health = 0;
                        P.TakeDamage(1, P, P.Location, vect(0,0,0), class'DM_Shot');
