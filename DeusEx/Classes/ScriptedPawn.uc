...
function rotator AdjustAim(float projSpeed, vector projStart, int aimerror, bool leadTarget, bool warnTarget)
{
    ...
    bIsThrown = IsThrownWeapon(DeusExWeaponInv(Weapon));
...
/*  local Class<ThrownProjectile> throwClass;
    ...
    return bIsThrown;*/
    return TestWeapon.IsA('GrenadeWeaponInv');
}
...
/*-- Fix pickups...--*/
     ...
     if (InitialInventory[i].Inventory == class'DeusEx.WineBottle')
          InitialInventory[i].Inventory = class'DeusEx.WineBottleInv';

     if (InitialInventory[i].Inventory == class'DeusEx.VialCrack')
          InitialInventory[i].Inventory = class'DeusEx.VialCrackInv';

     if (InitialInventory[i].Inventory == class'DeusEx.VialAmbrosia')
          InitialInventory[i].Inventory = class'DeusEx.VialAmbrosiaInv';

     if (InitialInventory[i].Inventory == class'DeusEx.SodaCan')
          InitialInventory[i].Inventory = class'DeusEx.SodaCanInv';

     if (InitialInventory[i].Inventory == class'DeusEx.MedKit')
          InitialInventory[i].Inventory = class'DeusEx.MedKitInv';

     if (InitialInventory[i].Inventory == class'DeusEx.LiquorBottle')
          InitialInventory[i].Inventory = class'DeusEx.LiquorBottleInv';

     if (InitialInventory[i].Inventory == class'DeusEx.Liquor40oz')
          InitialInventory[i].Inventory = class'DeusEx.Liquor40ozInv';

     if (InitialInventory[i].Inventory == class'DeusEx.FireExtinguisher')
          InitialInventory[i].Inventory = class'DeusEx.FireExtinguisherInv';

     if (InitialInventory[i].Inventory == class'DeusEx.BioelectricCell')
          InitialInventory[i].Inventory = class'DeusEx.BioelectricCellInv';

     if (InitialInventory[i].Inventory == class'DeusEx.AugmentationUpgradeCannister')
          InitialInventory[i].Inventory = class'DeusEx.AugmentationUpgradeCannisterInv';

     if (InitialInventory[i].Inventory == class'DeusEx.AugmentationCannister')
          InitialInventory[i].Inventory = class'DeusEx.AugmentationCannisterInv';

     if (InitialInventory[i].Inventory == class'DeusEx.CandyBar')
          InitialInventory[i].Inventory = class'DeusEx.CandyBarInv';

     if (InitialInventory[i].Inventory == class'DeusEx.Cigarettes')
          InitialInventory[i].Inventory = class'DeusEx.CigarettesInv';

     if (InitialInventory[i].Inventory == class'DeusEx.SoyFood')
          InitialInventory[i].Inventory = class'DeusEx.SoyFoodInv';

     if (InitialInventory[i].Inventory == class'DeusEx.Flare')
          InitialInventory[i].Inventory = class'DeusEx.FlareInv';

     if (InitialInventory[i].Inventory == class'DeusEx.DataVaultImage')
          InitialInventory[i].Inventory = class'DeusEx.DataVaultImageInv';

     if (InitialInventory[i].Inventory == class'DeusEx.credits')
          InitialInventory[i].Inventory = class'DeusEx.creditsinv';

     if (InitialInventory[i].Inventory == class'DeusEx.TechGoggles')
          InitialInventory[i].Inventory = class'DeusEx.TechGogglesInv';

     if (InitialInventory[i].Inventory == class'DeusEx.Rebreather')
          InitialInventory[i].Inventory = class'DeusEx.RebreatherInv';

     if (InitialInventory[i].Inventory == class'DeusEx.BallisticArmor')
          InitialInventory[i].Inventory = class'DeusEx.BallisticArmorInv';

     if (InitialInventory[i].Inventory == class'DeusEx.HazMatSuit')
          InitialInventory[i].Inventory = class'DeusEx.HazMatSuitInv';
