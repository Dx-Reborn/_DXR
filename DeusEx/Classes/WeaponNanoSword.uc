...
// WeaponNanoSword.
//=============================================================================
class WeaponNanoSword extends H2H_Weapon;
...
function Sound GetDownSound()
{
    ...
    if (gl.bUseAltWeaponsSounds)
    {
        sound = class'DXRWeaponSoundManager'.static.GetNanoSwordDown(gl.WS_Preset);
        if (sound != None)
        return sound;
        else
...
defaultproperties
{
     ...
     PickupViewMesh=Mesh'DeusExItems.NanoSwordPickup'
