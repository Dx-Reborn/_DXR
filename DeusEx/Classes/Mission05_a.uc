...
// Mission05.
//=============================================================================
class Mission05_a extends MissionScript;
            ...
            if (Player.Inventory != None)
            {
                ...
                foreach AllActors(class'SpawnPoint', SP, 'player_inv')
                {
                    ...
                    if (item != None)
                    {
                        ...
                        if (item.IsA('DeusExWeapon') && (DeusExWeapon(item).AmmoType != None) && item.IsA('WeaponGrenade')) // DXR: All grenades now inherited from GrenadeWeaponInv
                            DeusExWeapon(item).PickupAmmoCount = DeusExWeapon(item).default.PickupAmmoCount;
                    }
