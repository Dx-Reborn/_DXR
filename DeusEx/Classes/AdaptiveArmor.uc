...
defaultproperties
{
    ...
    StaticMesh=StaticMesh'DXR_Pickups.AdaptiveArmor'
    FirstPersonViewStaticMesh=StaticMesh'DXR_Pickups.AdaptiveArmor'
    PickupViewStaticMesh=StaticMesh'DXR_Pickups.AdaptiveArmor'
