//
// ќкно дл€ интерактивных (и не только) диалогов и вариантов ответа.
// ConWinThird
//
...
const WHEEL_SCROLL_DELAY = 0.05; // «адержка при "проматывании" диалогов.
     ...
     if (DeusExPlayerController(PlayerOwner()).bHUDBordersTranslucent)
        ...
        for(x=0; x<ReceivedItems.length; x++)
        {
          if (ReceivedItems[x].anItem != None)
          {
            ...
            {
                u.SetDrawColor(255,255,255); // »справлено, иконки были залиты текущим цветом.
