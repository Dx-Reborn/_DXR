...
// ElectricityEmitter.
//=============================================================================
class ElectricityEmitter extends EM_LaserBeam; //LaserEmitter;
...
function RandomizeBeams()
{
  	...
  	BeamEmitter(Emitters[0]).LowFrequencyNoiseRange.X.Min= -(randomAngle / 128);
  	BeamEmitter(Emitters[0]).LowFrequencyNoiseRange.X.Max=  (randomAngle / 128);

  	BeamEmitter(Emitters[0]).LowFrequencyNoiseRange.Y.Min= -(randomAngle / 128);
  	BeamEmitter(Emitters[0]).LowFrequencyNoiseRange.Y.Max=  (randomAngle / 128);

  	BeamEmitter(Emitters[0]).LowFrequencyNoiseRange.Z.Min= -(randomAngle / 128);
  	BeamEmitter(Emitters[0]).LowFrequencyNoiseRange.Z.Max=	(randomAngle / 128);
}

function SetInitialState() //PostPostBeginPlay()
{
