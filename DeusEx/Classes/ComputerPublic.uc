...
var() localized string extraMessages[4]; // Дополнительные сообщения если список пуст.
...
defaultproperties
{
    ...
    extraMessages(3)="Bad command or filename.|Недопустимая команда или имя файла."
}
