...
var MultitoolInv			curTool;				// the multitool that is being used // Вариант для инвентаря!
...
//	local float dotp;
	...
	if (!bDone)
	{
		...
		if (frobWith != None)
		{
			...
			if (bHackable && frobWith.IsA('MultitoolInv') && (Player.SkillSystem != None))
			{
				if (hackStrength > 0.0)
				{
