class DeusExNpcPawn extends DeusExPawn exportstructs native;
...
native /*(2105)*/ final function bool IsValidEnemy(DeusExPawn TestEnemy, optional bool bCheckAlliance);
native /*(2106)*/ final function EAllianceType GetAllianceType(Name AllianceName);
native /*(2107)*/ final function EAllianceType GetPawnAllianceType(DeusExPawn QueryPawn);
...
cpptext
{
	NO_DEFAULT_CONSTRUCTOR(ADeusExNpcPawn);

	virtual UBOOL Tick(FLOAT DeltaTime, enum ELevelTick TickType);

	UBOOL IsValidEnemy(ADeusExPawn* testPawn, UBOOL bCheckAlliance = TRUE);
	EAllianceType GetAllianceType(FName allianceName);
	EAllianceType GetPawnAllianceType(ADeusExPawn* queryPawn);
